    ...
    return (
        <ul className={`mail-folder-list clean-list ${selectedFolder}`}>
            <li className="mail-folder-container inbox">
                <input onClick={onFolderClicked} folder="radio" name="folder" id="inbox" value="inbox" readOnly/>
                <label htmlFor="inbox"><i className="icon fa-solid fa-inbox"></i><span>Inbox</span></label>
            </li>
            <li className="mail-folder-container sent">
                <input onClick={onFolderClicked} folder="radio" name="folder" id="sent" value="sent" readOnly/>
            ...
            <li className="mail-folder-container trash">
                <input onClick={onFolderClicked} folder="radio" name="folder" id="trash" value="trash" readOnly/>
            ...
            <li className="mail-folder-container drafts">
                <input onClick={onFolderClicked} folder="radio" name="folder" id="drafts" value="drafts" readOnly/>
